...
<div class='con'>
<div class='conn'>
<form name="frm" method="POST" action='logcheck.php'>
 Email:&nbsp;<input type="text" name="txt1" placeholder="Email">
<br><br>
 Password:<input type="password" name="txt2" placeholder="Password"><br><br>
